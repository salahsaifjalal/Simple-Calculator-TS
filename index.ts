...
systemSays.speak(
  "This Calculator is made by Salahuddin Muhammad",
  undefined,
  0.75,
  (error_found) => {
    if (error_found) {
...
let askQuestion = async function () {
  ...
  if (answer.operator === "Addition") {
    ...
    systemSays.speak(
      `You perfromed Subtraction operation of ${answer.firstNumber} & ${
        answer.secondNumber
      } and 
      the result is: ${answer.firstNumber - answer.secondNumber}`,
      undefined,
    ...
    systemSays.speak(
      `You perfromed Multiplication operation of ${answer.firstNumber} & ${
        answer.secondNumber
      } and 
      the result is: ${answer.firstNumber * answer.secondNumber}`,
      undefined,
    ...
    systemSays.speak(
      `You perfromed Division operation of ${answer.firstNumber} & ${
        answer.secondNumber
      } and 
      the result is: ${answer.firstNumber / answer.secondNumber}`,
      undefined,
    ...
    systemSays.speak(
      `You perfromed Remainder operation of ${answer.firstNumber} & ${
        answer.secondNumber
      } and 
      the result is: ${answer.firstNumber % answer.secondNumber}`,
      undefined,
    ...
    systemSays.speak(
      "Please select any valid operation",
      undefined,
      undefined,
      (error_found) => {
        if (error_found) {
